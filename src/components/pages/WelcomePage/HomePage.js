...
// Possible for future use as an entry point to both login and sign up.
function HomePage() {
  return (
    <Layout className="welcome-page-layout">
      <Container>
        ...
        <Card className="mt-3">
          <Card.Body>
            <Card.Text>
              Mobilise was built and developed by 4 Computing Students in their
              2nd year at Imperial College London alongside the help of the
              staff and volunteers of City Harvest London.
            </Card.Text>
          </Card.Body>
        </Card>
